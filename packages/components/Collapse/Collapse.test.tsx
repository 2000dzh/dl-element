...
describe('Collapse.vue', () => {
	beforeAll(() => {
		...
		headers = wrapper.findAll('.dl-collapse-item__header');
		contents = wrapper.findAll('.dl-collapse-item__wapper');
	...
	test('手风琴模式 错误处理', () => {
        ...
        [
          [
            [DlUIError: [DlCollapse] accordion mode should only have one active item],
          ],
        ]
      `
		);
